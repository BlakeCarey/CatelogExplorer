...
var ToastMessage = React13.memo(React13.forwardRef(function(props, ref) {
  ...
  var _React$useState = React13.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), focused = _React$useState2[0], setFocused = _React$useState2[1];
  ...
  var createCloseIcon = function createCloseIcon2() {
    ...
    var icon = _closeIcon || React13.createElement(TimesIcon, buttonIconProps);
    ...
    if (closable !== false) {
      return React13.createElement("div", null, React13.createElement("button", closeButtonProps, closeIcon2, React13.createElement(Ripple, null)));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (messageInfo) {
      ...
      if (!_icon) {
        switch (severity) {
          case "info":
            icon = React13.createElement(InfoCircleIcon, iconProps);
            break;
          case "warn":
            icon = React13.createElement(ExclamationTriangleIcon, iconProps);
            break;
          case "error":
            icon = React13.createElement(TimesCircleIcon, iconProps);
            break;
          case "success":
            icon = React13.createElement(CheckIcon, iconProps);
            break;
        }
      }
      ...
      return contentEl || React13.createElement(React13.Fragment, null, messageIcon, React13.createElement("div", textProps, React13.createElement("span", summaryProps, summary), detail && React13.createElement("div", detailProps, detail)));
    }
    return null;
  };
  ...
  return React13.createElement("div", messageProps, React13.createElement("div", contentProps, message2, closeIcon));
}));
ToastMessage.displayName = "ToastMessage";
var messageIdx = 0;
var Toast = React13.memo(React13.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React13.useContext(PrimeReactContext);
  var props = ToastBase.getProps(inProps, context);
  var _React$useState = React13.useState([]), _React$useState2 = _slicedToArray(_React$useState, 2), messagesState = _React$useState2[0], setMessagesState = _React$useState2[1];
  var containerRef = React13.useRef(null);
  var metaData = {
    props,
    state: {
  ...
  var createElement8 = function createElement9() {
    ...
    return React13.createElement("div", rootProps, React13.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(messageInfo, index) {
      var messageRef = React13.createRef();
      return React13.createElement(CSSTransition2, _extends7({
        ...
        message: messageInfo.message
      }) : React13.createElement(ToastMessage, {
        hostName: "Toast",
        ref: messageRef,
        messageInfo,
        index,
